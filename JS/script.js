...
const translations = {
 ...
 // خبرة 1
  ...
  ar: {
    ...
    "hero-subtitle": "أقود أبحاثًا في مجالي الذكاء الاصطناعي والأمن السيبراني — أعمل على تطوير أنظمة ذكية لاكتشاف التهديدات، ونماذج تحافظ على الخصوصية، واعتماد الذكاء الاصطناعي بشكل أخلاقي. استكشف أعمالي ولنؤمّن المستقبل معًا.",
    "view-projects": "عرض المشاريع",
    "hire-me": "وظفني",

    "about-heading": "عنّي",
    "about-paragraph": "أعمل في مجال تكامل الأمن السيبراني والذكاء الاصطناعي، حيث أساعد المؤسسات على تبني التقنيات الحديثة بشكل آمن وأخلاقي. وبفضل خلفيتي في إدارة تكنولوجيا المعلومات وحصولي على ماجستير في الأمن السيبراني من جامعة لانكستر، فإن عملي يجمع بين البحث والتطبيق العملي — رابطًا بين الحوكمة والتقنية في الواقع.\n أشغل حاليًا منصب مدير أمن المعلومات في شركة خبرة لتحصيل ديون جهات التمويل (وهي شركة مالية خاضعة لتنظيم مؤسسة النقد العربي السعودي \"ساما\")، كما أرأس جمعية بُنية — جمعية أهلية مختصة في للذكاء الاصطناعي والبيانات — لدعم المنظمات غير الربحية في الاستفادة من الذكاء الاصطناعي والبيانات بطريقة مسؤولة.\n\nاهتماماتي تتنوع بين أمن الأنظمة الموزعة، والتعلم الآلي المحافظ على الخصوصية، وحوكمة الذكاء الاصطناعي للمنظمات غير الربحية والقطاعات الناشئة.",
